                ...
                <table>
                    ...
                    <span class="no-2">
                        <tr>
                            <td>2.</td>
                            <td>
                                Suatu situs internet memiliki video mengenai cara membuat suatu grafik khusus. Di situs itu ada orang yang bicara, ada daftar langkah pembuatan video, dan ada beberapa diagram. Saya paling mengerti isi situs itu dengan cara:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-3">
                        <tr>
                            <td>3.</td>
                            <td>
                                Saya ingin mengetahui lebih dalam mengenai suatu tur wisata yang saya rencanakan. Saya akan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-6">
                        <tr>
                            <td>6.</td>
                            <td>
                                Saya ingin menabung lebih banyak dan mempertimbangkan beberapa cara. Saya akan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-7">
                        <tr>
                            <td>7.</td>
                            <td>
                                Saya ingin mempelajari suatu jenis permainan kartu yang baru. Saya akan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-8">
                        <tr>
                            <td>8.</td>
                            <td>
                                Saya mempunyai masalah jantung. Saya lebih suka dokter yang:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-9">
                        <tr>
                            <td>9.</td>
                            <td>
                                Saya ingin mempelajari suatu program baru di komputer. Saya akan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-10">
                        <tr>
                            <td>10.</td>
                            <td>
                                Ketika belajar sesuatu dari internet, saya menyukai:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-11">
                        <tr>
                            <td>11.</td>
                            <td>
                                Saya ingin mempelajari suatu proyek kerja yang baru. Saya akan meminta:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-12">
                        <tr>
                            <td>12.</td>
                            <td>
                                Saya ingin belajar cara memotret dengan lebih baik. Saya akan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-13">
                        <tr>
                            <td>13.</td>
                            <td>
                                Saya lebih suka pembicara yang dalam presentasinya menggunakan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-14">
                        <tr>
                            <td>14.</td>
                            <td>
                                Saya baru saja menyelesaikan suatu lomba atau suatu ujian dan saya ingin umpan balik orang lain. Saya mengharapkan:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-15">
                        <tr>
                            <td>15.</td>
                            <td>
                                Saya tertarik dengan suatu rumah atau apartemen. Sebelum berkunjung, saya ingin:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
                    ...
                    <span class="no-16">
                        <tr>
                            <td>16.</td>
                            <td>
                                Saya ingin merakit satu set meja kayu yang belum jadi. Saya paling mengerti jika:
                            </td>
                        </tr>
                        <tr>
                            <td></td>
