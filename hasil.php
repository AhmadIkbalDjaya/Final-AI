<?php
    $SB = "";
    $SV = ' <div class="strategiBelajarVisual">
    ...
    $SA = ' <div class="strategiBelajarAural">
    ...
    $SR = ' <div class="strategiBelajarRead/Write">
    ...
    $SK = ' <div class="strategiBelajarKinestetik">
